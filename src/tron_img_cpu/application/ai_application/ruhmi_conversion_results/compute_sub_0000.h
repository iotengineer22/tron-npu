...
enum BufferSize_sub_0000 {
  ...
  kBufferSize_sub_0000 = 305521
#elif defined(ARM_MATH_DSP)
  kBufferSize_sub_0000 = 301169
#else
  kBufferSize_sub_0000 = 301169
#endif
...
void compute_sub_0000(
  ...
  uint8_t* main_storage, // should provide at least 301169 bytes of storage

  // inputs
  
  const float serving_default_keras_tensor_91_0[150528], // 1,224,224,3
  

  // outputs
  
  float StatefulPartitionedCall_1_0_70088[1000]  // 1,1000
