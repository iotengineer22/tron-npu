...
#define CAMERA_CONFIG_WRITE_VERIFY   (1) // 0: Disabled, 1: Enabled
...
extern "C" int tm_printf(const unsigned char *format, ...);
#define CAMERA_I2C_DEBUG(fn_, ...)   tm_printf((const unsigned char *)(fn_), ##__VA_ARGS__)
