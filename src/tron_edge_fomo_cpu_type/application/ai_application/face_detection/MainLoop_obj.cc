...
bool main_loop_face_detection()
{
    ...
    // Diagnostics for CPU Output (5 classes)
    ...
    e_printf("[CPU Output Stats] C0: [%d, %d] avg %d | C1: [%d, %d] avg %d | C2: [%d, %d] avg %d | C3: [%d, %d] avg %d | C4: [%d, %d] avg %d\n",
