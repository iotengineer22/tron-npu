...
#define kArenaSize_sub_0000 589824

// Addresses for each input and output buffer inside of the arena
extern const uint32_t sub_0000_address_serving_default_x_0;
extern const uint32_t sub_0000_address_StatefulPartitionedCall_0_70066;
