...
int8_t buf_serving_default_x_0[110592];

// Arenas for CPU units

  // Model input pointers
int8_t* GetModelInputPtr_serving_default_x_0() {
  return (int8_t*) (sub_0000_arena + sub_0000_address_serving_default_x_0);
}


  // Model output pointers
int8_t* GetModelOutputPtr_StatefulPartitionedCall_0_70066() {
  return (int8_t*) (sub_0000_arena + sub_0000_address_StatefulPartitionedCall_0_70066);
}


void RunModel(bool clean_outputs) {
  // Buffers for NPU units
  int8_t* buf_StatefulPartitionedCall_0_70066 = (int8_t*) (sub_0000_arena + sub_0000_address_StatefulPartitionedCall_0_70066);
