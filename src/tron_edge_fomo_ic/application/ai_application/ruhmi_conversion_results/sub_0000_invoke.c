...
uint8_t sub_0000_arena[589824] BSP_ALIGN_VARIABLE(32);
#elif (TENSOR_ARENA_ALLOCATION == ALLOCATE_TO_SDRAM)
uint8_t sub_0000_arena[589824] BSP_PLACE_IN_SECTION(".sdram") BSP_ALIGN_VARIABLE(32);
#else
...
int sub_0000_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0000_model with size 39536 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0000_model_data;
  base_addrs_size[0] = sub_0000_model_data_size;
  // Buffer sub_0000_arena with size 589824 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0000_arena+0);
  base_addrs_size[1] = 589824;

  // Buffer sub_0000_fast_scratch with size 589824 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0000_arena+0);
  base_addrs_size[2] = 589824;
  ...
  // Buffer output_tensor_0 with size 1728 and address: 0
  if (clean_outputs) {
    memset(sub_0000_arena + 0, 0, 1728);
  }
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0000_arena+0);
  base_addrs_size[4] = 1728;
