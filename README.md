# μT-Kernel 3.0とNPU/GPUの協調並列駆動による超リアルタイム画像AI認識システム

本リポジトリは、ルネサスエレクトロニクス製マイコン **EK-RA8P1**（Cortex-M85 / 480MHz / Ethos-U55 NPU搭載）とリアルタイムOS **μT-Kernel 3.0** を用いた、TRONプログラミングコンテスト2026応募用の開発プロジェクトです。
